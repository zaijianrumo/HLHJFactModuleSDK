...
@interface HLHJFFactInputToolbar () <UITextViewDelegate>
...
@implementation HLHJFFactInputToolbar
...
- (void)keyboardWillShow:(NSNotification *)notification
{
    ...
    self.y = keyboardFrame.origin.y-self.height-kSNavBarHeight;
...
- (void)textViewDidChange:(UITextView *)textView
{
    ...
    if (self.textInput.scrollEnabled) {
        ...
        self.y = SCREEN_HEIGHT - _keyboardHeight - _textInputMaxHeight - 5 - 10-kSNavBarHeight;
        ...
        self.y = SCREEN_HEIGHT - _keyboardHeight - _textInputHeight - 5 - 10-kSNavBarHeight;
