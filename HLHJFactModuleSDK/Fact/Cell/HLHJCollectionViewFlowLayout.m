//
//  HLHJCollectionViewFlowLayout.m
//  HLHJFactModuleSDK
//
...
@interface HLHJCollectionViewFlowLayout () <UIGestureRecognizerDelegate>
...
@implementation HLHJCollectionViewFlowLayout
{
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            HLHJCollectionViewCell *sourceCell = (HLHJCollectionViewCell *)sourceCollectionViewCell;
